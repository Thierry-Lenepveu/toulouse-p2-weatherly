...
const apiKeys = [
  import.meta.env.VITE_WEATHERLY_API_KEY1,
  import.meta.env.VITE_WEATHERLY_API_KEY2,
  import.meta.env.VITE_WEATHERLY_API_KEY3,
  import.meta.env.VITE_WEATHERLY_API_KEY4,
];

let apiKeyIndex = 0;

function apiKey() {
  console.info(JSON.stringify(apiKeys, null, 2));
